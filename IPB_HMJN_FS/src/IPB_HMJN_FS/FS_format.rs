...
fn write_super_block_data(super_block: &FS_core_types::SuperBlockData, output_file: &mut fs::File) -> result::Result<(), Box<dyn error::Error>>{
    ...
    output_file.write_all(&super_block.bitmap_cluster_num.to_le_bytes())?;
    output_file.write_all(&super_block.bitmap_size.to_le_bytes())?;
    output_file.write_all(&super_block.back_up_num.to_le_bytes())?;
    output_file.write_all(&super_block.back_up_list_cluster_num.to_le_bytes())?;
    ...
    output_file.write_all(&super_block.free_ID_tree_cluster_num.to_le_bytes())?;
    output_file.write_all(&super_block.free_ID_tree_depth.to_le_bytes())?;
